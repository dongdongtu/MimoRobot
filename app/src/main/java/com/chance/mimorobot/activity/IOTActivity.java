...
public class IOTActivity extends TitleBarActivity {
    ...
    private int[] homepageIcons = new int[]{R.drawable.adddevice};
    ...
    private void clickItemView(int position) {
        switch (position) {
            ...
            case 1:
                //验证版本以防跳出
                Toasty.warning(IOTActivity.this,"暂未开放",Toast.LENGTH_SHORT).show();
                break;
            case 2:
