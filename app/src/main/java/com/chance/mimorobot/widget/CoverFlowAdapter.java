...
public class CoverFlowAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public CoverFlowAdapter(List<View> mImageViewList, Context context) {
        ...
        mContext = context;
        sWidthPadding = dp2px(20);
        sHeightPadding = dp2px(48);
    }
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (mViewList.size() > 0 && position < mViewList.size()) {
            ...
            mViewList.get(position).setPadding(outWidthPadding, outHeightPadding, outWidthPadding, 0);
            ...
            if (position < mViewList.size() - 1) {
                ...
                mViewList.get(position + 1).setPadding(inWidthPadding, inHeightPadding, inWidthPadding, 0);
            }
        }
    }
