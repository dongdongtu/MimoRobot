...
public class SerialControl extends BaseSerial {
    ...
    @Override
    public void leftHandStop() {
        sendCmdWithCompose(BaseSerial.SEND_LEFT_HAND, 0);
    }
    ...
    @Override
    public void rightHandStop() {
        sendCmdWithCompose(BaseSerial.SEND_RIGHT_HAND, 0);
    }
    ...
    public void stopRotateHead() {
        sendCmdWithCompose(BaseSerial.SEND_HEAD, 0);
    }
    ...
    public void expression(int type) {
        if (mSerialListener != null) mSerialListener.onExpression(type - 1);
    }
    ...
    @Override
    public void send433Control(String id, String cmdId) {
        sendCmdWithCompose(BaseSerial.SEND_433_CONTROL, id, cmdId);
    }
}
