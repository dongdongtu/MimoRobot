...
public abstract class BaseSerial {
     ...
     * 433控制
     */
    public static final int SEND_433_CONTROL = 8;
    /**
     * CAN 总线升级
     */
    public static final int SEND_CAN_UPDATE = 9;

    /**
     * 状态反馈
     */
    public static final int SEND_STATUS = 10;
     ...
     * 左手停止
     */
    public abstract void leftHandStop();
     ...
     * 右手停止
     */
    public abstract void rightHandStop();
     ...
     * 头部停止
     */
    public abstract void stopRotateHead();
     ...
     * 设置灯带颜色
     *
     * @param mode LAMP_MODE_CHARGING = 3;//充电
     ...
     * @param cmdId 命令号
     */
    public abstract void send433Control(String id, String cmdId);
